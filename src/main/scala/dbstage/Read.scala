...
object Read {
  ...
  */
  ...
  @desugar implicit def readBool = Read.instance[Bool] { (str: String) => str.toBoolean }
  @desugar implicit def readDouble = Read.instance[Double] { (str: String) => str.toDouble }
  @desugar implicit def readInt = Read.instance[Int] { (str: String) => str.toInt }
  @desugar implicit def readLong = Read.instance[Long] { (str: String) => str.toLong }
  @desugar implicit def readString = Read.instance[String] { (str: String) => str }
  @desugar implicit def readDate = Read.instance[example.tpch.Date] { (str: String) => example.tpch.Date(str) }
